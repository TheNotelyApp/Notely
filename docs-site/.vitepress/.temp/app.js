...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.B_D79mPK.js"));
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["notely-callout", __props.type],
        role: "note",
        "aria-label": `${labelText.value} callout`
      }, _attrs))} data-v-42f108e5><div class="callout-header" data-v-42f108e5><span class="callout-icon" aria-hidden="true" data-v-42f108e5>${ssrInterpolate(icon.value)}</span><span class="callout-label" data-v-42f108e5>${ssrInterpolate(labelText.value)}</span></div><div class="callout-body" data-v-42f108e5>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></div>`);
    };
  }
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../docs-site/.vitepress/theme/components/NotelyCallout.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const NotelyCallout = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-42f108e5"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "ShortcutTable",
  __ssrInlineRender: true,
  props: {
    shortcuts: {},
    context: { default: "Keyboard" }
  },
  setup(__props) {
    function toKeyList(key) {
      return key.split("+").map((k) => k.trim());
    }
    function macify(key) {
      return key.replace(/Ctrl/gi, "⌘").replace(/Alt/gi, "⌥").replace(/Shift/gi, "⇧").replace(/Cmd/gi, "⌘");
    }
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "shortcut-table-wrapper" }, _attrs))} data-v-4607adc0><table class="shortcut-table"${ssrRenderAttr("aria-label", `${__props.context} keyboard shortcuts`)} data-v-4607adc0><thead data-v-4607adc0><tr data-v-4607adc0><th scope="col" data-v-4607adc0>Action</th><th scope="col" data-v-4607adc0>Windows / Linux</th><th scope="col" data-v-4607adc0>macOS</th></tr></thead><tbody data-v-4607adc0><!--[-->`);
      ssrRenderList(__props.shortcuts, (s) => {
        _push(`<tr data-v-4607adc0><td class="action-cell" data-v-4607adc0>${ssrInterpolate(s.action)}</td><td class="key-cell" data-v-4607adc0><!--[-->`);
        ssrRenderList(toKeyList(s.win ?? s.key), (key) => {
          _push(`<kbd data-v-4607adc0>${ssrInterpolate(key)}</kbd>`);
        });
        _push(`<!--]--></td><td class="key-cell" data-v-4607adc0><!--[-->`);
        ssrRenderList(toKeyList(s.mac ?? macify(s.key)), (key) => {
          _push(`<kbd data-v-4607adc0>${ssrInterpolate(key)}</kbd>`);
        });
        _push(`<!--]--></td></tr>`);
      });
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../docs-site/.vitepress/theme/components/ShortcutTable.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const ShortcutTable = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4607adc0"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "feature-matrix-wrapper" }, _attrs))} data-v-e0e0ebb4><table class="feature-matrix" aria-label="Feature availability matrix" data-v-e0e0ebb4><thead data-v-e0e0ebb4><tr data-v-e0e0ebb4><th scope="col" data-v-e0e0ebb4>Feature</th><th scope="col" data-v-e0e0ebb4>Available by default</th><th scope="col" data-v-e0e0ebb4>Needs setup</th><th scope="col" data-v-e0e0ebb4>Internet required</th></tr></thead><tbody data-v-e0e0ebb4><!--[-->`);
      ssrRenderList(__props.features, (f) => {
        _push(`<tr data-v-e0e0ebb4><td class="feature-name" data-v-e0e0ebb4>${ssrInterpolate(f.feature)}</td><td data-v-e0e0ebb4>`);
        _push(ssrRenderComponent(unref(StatusIcon), {
          value: f.available
        }, null, _parent));
        _push(`</td><td data-v-e0e0ebb4>`);
        if (f.setup && f.setup !== "No") {
          _push(`<span class="setup-label" data-v-e0e0ebb4>${ssrInterpolate(f.setup)}</span>`);
        } else {
          _push(ssrRenderComponent(unref(StatusIcon), {
            value: f.setup === "No" ? false : false
          }, null, _parent));
        }
        _push(`</td><td data-v-e0e0ebb4>`);
        _push(ssrRenderComponent(unref(StatusIcon), {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../docs-site/.vitepress/theme/components/FeatureMatrix.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const FeatureMatrix = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e0e0ebb4"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "HomeLayout",
  __ssrInlineRender: true,
  setup(__props) {
    useRoute();
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(theme).Layout, _attrs, null, _parent));
    };
  }
});
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../docs-site/.vitepress/theme/HomeLayout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const RawTheme = {
  extends: theme,
