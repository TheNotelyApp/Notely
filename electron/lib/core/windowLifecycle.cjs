...
<html>
  ...
  function handleMenuContextUpdate(event, context) {
    ...
    win.__menuContext = {
      ...
      writeMetadataToFile: context?.writeMetadataToFile !== false,
      ...
      scrollSyncEnabled: context?.scrollSyncEnabled !== false,
      tableEditorEnabled: context?.tableEditorEnabled !== false,
