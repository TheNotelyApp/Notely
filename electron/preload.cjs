...
contextBridge.exposeInMainWorld("notesApi", {
  ...
  wireframeReadSource: (payload) => ipcRenderer.invoke("wireframe:read-source", payload),
  wireframeWriteSource: (payload) => ipcRenderer.invoke("wireframe:write-source", payload),
  wireframeWriteImage: (payload) => ipcRenderer.invoke("wireframe:write-image", payload),
  wireframeReadImage: (payload) => ipcRenderer.invoke("wireframe:read-image", payload),
  wireframeDelete: (payload) => ipcRenderer.invoke("wireframe:delete", payload),
  wireframeExists: (payload) => ipcRenderer.invoke("wireframe:exists", payload),
