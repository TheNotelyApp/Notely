...
const MARKDOWN_SYNTAX = [
  ...
  { id: 4, syntax: "**Bold text**", description: "Strong emphasis (Ctrl/Cmd+B)", example: "<b>Bold text</b>" },
  { id: 5, syntax: "*Italic text*", description: "Emphasis (Ctrl/Cmd+I)", example: "<i>Italic text</i>" },
  { id: 6, syntax: "~~Strikethrough~~", description: "Strike out text (Ctrl/Cmd+Shift+X)", example: "<del>Strikethrough</del>" },
  { id: 7, syntax: "- Item 1\n- Item 2", description: "Unordered list (Tab/Shift+Tab indents)", example: "• Item 1\n• Item 2" },
  { id: 8, syntax: "1. Item 1\n2. Item 2", description: "Ordered list", example: "1. Item 1\n2. Item 2" },
  { id: 9, syntax: "- [ ] Task\n- [x] Done", description: "Task list (Ctrl/Cmd+Enter toggles checkbox)", example: "☐ Task\n☑ Done" },
  ...
  { id: 12, syntax: "`inline code`", description: "Inline code snippet (Ctrl/Cmd+E)", example: "<code>inline code</code>" },
